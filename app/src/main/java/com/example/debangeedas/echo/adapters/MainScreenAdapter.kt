...
import com.example.debangeedas.echo.fragments.SongPlayingFragment
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        * trackArtist for holding the name of the artist*/
        ...
        holder.contentHolder?.setOnClickListener {
            ...
            val songPlayingragment = SongPlayingFragment()

            /*A bundle is used to transfer data from one point in your activity to another
       * Here we create an object of Bundle to send the sond details to the fragment so that we can
       * display the song details there and also play the song*/
            var args = Bundle()
       ...
       * Note: Remember the name of the strings/entities you place inside the bundle object as you will retrieve them later using the same name. And these names are case-sensitive*/
            ...
            //Linking the Bundle class object with the song playing fragment
            songPlayingragment.arguments = args

            /*Now after placing the song details inside the bundle, we inflate the song playing fragment*/
            (mContext as FragmentActivity).supportFragmentManager
                    .beginTransaction()
                    .replace(R.id.details_fragment, songPlayingragment)
                    .commit()
        }
    }
