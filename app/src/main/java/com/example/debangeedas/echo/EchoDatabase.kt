...
import com.example.debangeedas.echo.EchoDatabase.Staticated.COLUMN_SONG_ARTIST
import com.example.debangeedas.echo.EchoDatabase.Staticated.COLUMN_SONG_PATH
import com.example.debangeedas.echo.EchoDatabase.Staticated.COLUMN_SONG_TITLE
import com.example.debangeedas.echo.EchoDatabase.Staticated.DB_NAME
import com.example.debangeedas.echo.EchoDatabase.Staticated.TABLE_NAME
...
class EchoDatabase : SQLiteOpenHelper {
    ...
    * If already a table with the same name is present in the database, then this method is skipped*/
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        *  SongTitle STRING,
        *  SongPath STRING);"  */
        db?.execSQL("CREATE TABLE " + TABLE_NAME + "( " + Staticated.COLUMN_ID +
